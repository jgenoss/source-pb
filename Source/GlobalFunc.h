...
#else
#define MEM_ENCRYPTION ///< Cifrado de memoria
#define MEM_ENCRYPTION_LV1 ///< Prioridad C
#define MEM_ENCRYPTION_LV2 ///< Prioridad B
#define MEM_ENCRYPTION_LV3 ///< Prioridad A
