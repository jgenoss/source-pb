...
void ClientTCPSocket::__Parse_Base_Connect(i3NetworkPacket* pPacket)
{
	...
	I3PRINTLOG(I3LOG_DEFALUT, "VSN C:%d.%d S:%d.%d ", ClientVersion._ui8VerGame, ClientVersion._ui16VerSC, ServerVersion._ui8VerGame, ServerVersion._ui16VerSC);
...
void ClientTCPSocket::__Parse_Base_GetUserInfo(i3NetworkPacket* pPacket)
{
	...
	if (S2MO_IS_SUCCESS(Recv.m_TResult))
	{
		...
		// Cash
		UserInfoContext::i()->SetMyCash(pUserInfoBasic->m_ui32Cash);

		std::cout << "UserInfoContext::i()->SetMyCash : " << pUserInfoBasic->m_ui32Cash << std::endl;
		std::cout << "UserInfoContext::i()->SetMyPoint : " << pUserInfoBasic->m_ui32Point << std::endl;
...
// El paquete que recibes cuando completas la compra de tu tarjeta.
