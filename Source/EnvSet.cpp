...
void CEnvSet::Load()
{
	...
	else
	{
		...
		if (pKey != nullptr)
		{
			...
			// Aquí, lo cambiamos a la fuerza a UI_V11... Vamos a cambiarlo... Ajuste forzado...
			// ¿Es correcto cambiarlo a la fuerza a 1.1 en tiempo de ejecución?

			SetUIVersion(UFV_1_5);
